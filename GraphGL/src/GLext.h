...
class OGLWindow
{
 ...
 public:
    ...
    void setReshapeFunc( void(*Callback)(void) ){ glutReshapeFunc(Callback); }
    void setKeyboardFunc( void(*Callback)(void) ){ glutKeyboardFunc(Callback); }
    void setMouseFunc( void(*Callback)(void) ){ glutMouseFunc(Callback); }
    void setMotionFunc( void(*Callback)(void) ){ glutMotionFunc(Callback); }
};
