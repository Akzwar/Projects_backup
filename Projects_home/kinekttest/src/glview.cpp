...
void DrawGLScene()
{
	...
	glBegin(GL_POINTS);
		for(int i = 0; i < m; i+=1)
			for(int j = 0; j < n; j+=1)
			{
				glColor3f((depth_front[i*n+j])/255,
					  (depth_front[i*n+j]>>2)/255,
					  (depth_front[i*n+j]>>4)/255);
				glVertex2f(j,i);
			}
	glEnd();
	*/
	...
	glBegin(GL_QUADS);
		glColor3f((depth_front[0])/255,(depth_front[1])/255,(depth_front[2])/255);
		glVertex2f(10,10);
		glVertex2f(100,10);
		glVertex2f(100,100);
		glVertex2f(10,100);
...
//	{
	//	case GLUT_RIGHT_BUTTON:
		//cout<<depth_front[y*640+x]<<endl;
		printf("%u,%u,%u,%u\n",depth_mid[x*480+y],depth_mid[x*480+y]>>2,depth_front[x*480+y]>>4,depth_front[x*480+y]>>6);
		fflush(stdout);
//	}
}
...
void *freenect_threadfunc(void *arg)
{
	...
	//	printf("%d,%d,%d,%d\n",depth_front[0],depth_front[1],depth_front[2],depth_front[3]);
	}
